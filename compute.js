function calculateRetirement() {
  ...
  document.getElementById("note").innerHTML = "This calculation is based on a 12% annual return (the historical average annual return of the S&P 500 over 30 years)."
}
